...
| 5 | [`flow-doc`](./flow-doc) | all three + diff | `docs/features/<f>/…` |
...
records, generated FEATURE-MAP.md / INDEX.md) and `tasks/`, and folds any
existing docs, plans or ADR pile into them — one confirmed row at a time.
